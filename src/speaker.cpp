...
//
// Пример отправки сообщений в канал очереди. Считывает содержимое всех файлов в дериктории и отправляет в очередь.
// Для контроля обработки сообщений на стороне приемника снабжает сообщения префиксами с разделителем.
// Предоставлены стандартные префиксы, но есть возможность ввести и кастомные значения (в том числе и разделитель).
//
